...
from pages import patient_profile_page
...
class TestPatients(BaseTest):
    ...
    def test_count_of_patient_after_patient_creation_is_increased(self, get_patient_data, login_as_admin):
        ...
        self.logger.info(f"current count of patients is displayed and = {count_of_patients_before_patient_creation}")
    ...
    def test_verify_patient_is_removed_by_admin(self, get_patient_data, login_as_admin):
        ...
        patient_profile_page_obj.click_remove_button()
        ...
        """Verify count of patient is decreased to 1"""
        assert count_of_patients_after_patient_is_created == count_of_patients_after_patient_is_removed + 1
        self.logger.info(
            f"count of patient actual: {count_of_patients_after_patient_is_created} expected: {count_of_patients_after_patient_is_removed}")
